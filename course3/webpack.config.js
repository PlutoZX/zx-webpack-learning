...
const OptimizeCssAssetsPlugin = require('optimize-css-assets-webpack-plugin'); // 用来优化压缩css （解决extract-text-webpack-plugin的css复制问题，不明白什么意思）（个人感觉在用css预处理器导致css-loader里配置压缩项无效的情况下可以压缩css，不知道对不对）
